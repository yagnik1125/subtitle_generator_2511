...
st.title("Live Audio to Text Conversion and Text Translation")

st.write("""
    Welcome to this web application designed to simplify audio-to-text transcription and video subtitle generation! This tool provides two main features: Audio to Text and Video to Subtitle, enabling users to easily convert their media content into text or subtitles for accessibility, content creation, or archiving purposes.
""")

st.write("""
    With the Audio to Text feature, you can upload audio files, and the system will accurately transcribe the spoken content into text, supporting multiple languages and accents. For video content, the Video to Subtitle feature lets you generate synchronized subtitles in formats like SRT or VTT by extracting the audio, transcribing it, and aligning it with the video timeline. This user-friendly interface ensures that even non-technical users can generate subtitles or transcriptions effortlessly.
""")

st.info("""
    Goto The side bar and choose audio2text for "Audio to Text simulation" or choose video2subtitle for subtitle generation on any video of your choice.
""")
